...
public class CalculadoraTest {
    ...
    public void testLimite1000() {
        ...
        List<Proposta> propostas = c.calcular(500, 800.00f);
    ...
    public void testLimite1001a5000() {
        Calculadora c = new Calculadora ();
        List<Proposta> propostas = c.calcular(2000, 1800.00f);
    ...
    @Test
    public void testLimiteAcima5000() {
        Calculadora c = new Calculadora ();
        List<Proposta> propostas = c.calcular(10000,5500.00f);
